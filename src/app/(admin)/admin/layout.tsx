...
const navItems = [
  ...
  { href: '/admin/coming-soon', label: 'Search Content', icon: Search },
  { href: '/admin/coming-soon', label: 'About Page', icon: Info },
  { href: '/admin/coming-soon', label: 'Manage Institutions', icon: ClipboardList },
];
